...
public class User_WorkoutSubscriptionController {
    ...
    private void addWorkoutSubscription(@RequestParam("days") int days, @RequestParam("name") String name, @RequestParam("price")Long price, @RequestParam("username") String username){
