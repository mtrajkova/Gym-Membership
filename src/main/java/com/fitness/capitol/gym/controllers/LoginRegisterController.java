...
public class LoginRegisterController {
    ...
    public void login(@RequestParam("username") String username, @RequestParam("password") String password, HttpSession session) throws InvalidLoginCredentialsException {
